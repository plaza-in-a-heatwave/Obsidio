...
public class Fanchuan extends Vessel {
	public static final String VESSELNAME = "fanchuan";

    public Fanchuan(GameContext context, String name, int x, int y) {
    ...
    public void setDefaultTexture() {
        this.setTexture(getVesselTexture("fanchuan"));
        this.setOrientationPack(getContext().getTools().getGson().fromJson(
                Gdx.files.internal("assets/vessel/fanchuan/sail.json").readString(),
                PackedObjectOrientation.class));
    }

    @Override
    public void setSinkingTexture() {
        this.setTexture(getVesselTexture("fanchuan_sinking"));
        this.setOrientationPack(getContext().getTools().getGson().fromJson(
                Gdx.files.internal("assets/vessel/fanchuan/sink.json").readString(),
                PackedObjectOrientation.class));
    }
}
